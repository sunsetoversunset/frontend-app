  ...
  return (
    ...
    >
      ...
      <h4 className='tooltip sources'>
        Sources
        <span className="tooltiptext">U.S. Bureau of the Census, <cite>Census of Population and Housing, 1960-2010</cite>, accessed via <a href="https://www.socialexplorer.com/" target='_blank'>Social Explorer</a> and <a href="https://www.nhgis.org/" target="_blank">IPUMS National Historical Geographic Information System (NHGIS)</a>.</span>
      </h4>
      <table>
        <thead>
          <tr className='year'>
