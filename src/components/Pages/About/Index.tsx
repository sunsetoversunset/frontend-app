  ...
  return (
    <Styled.About>
      ...
      <p>
        ...
        Filter” menu. Clicking on an individual photo opens a detailed view of a single image in a pop-up viewer, including the ability to zoom in closely and navigate to the next or previous photo. Selecting an address on the numerical band spanning the Panorama page, or suggested as a “nearby address” in the pop-up photo viewer, brings up a deeper profile of historical data associated with that
        property. Available resources vary by location but may include Ruscha's photographs, historical occupants, census tract-level demographic data, journalistic coverage, and links to external property databases. Finally, <Styled.Link to="/stories">Stories</Styled.Link> knit together photographs and properties to illuminate histories that have unfolded there, offering a platform to ask, “What
