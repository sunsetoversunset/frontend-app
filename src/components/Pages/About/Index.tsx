...
const About = () => {
  ...
  return (
      ...
      <p><b>Between 1965 and 2007</b>, artist Ed Ruscha photographed Los Angeles's Sunset Boulevard twelve times. Working with a team of collaborators, Ruscha devised a method—mounting a motorized 35mm camera atop a pickup truck and loading it with black and white (and later color) motion picture film—that captured continuous panoramas of one of LA's most famous streets. Largely unknown and unpublished outside of Ruscha's iconic 1966 book, Every Building on the Sunset Strip, these street-view photographs have become visible and available through the digitization efforts of the <a href="https://www.getty.edu/projects/ed-ruschas-streets-los-angeles/"></a>. While these images taken from a moving vehicle record the curious and innovative eye of a major American artist of the late 20th century, they also provide an unmatched record of small-scale urban change on one of the iconic streets in the United States. On Sunset Boulevard, changing natural and built environments trace local, national, and global histories of migration, economic transformation, architectural innovation, and cultural change. In Ruscha's photographs lies a powerful tool for urban history, and Sunset Over Sunset seeks to reveal that history.</p>
      ...
      <p>A collaborative digital humanities project, Sunset Over Sunset incorporates five years of Ruscha's Sunset Boulevard photographs, one photo set for each decade, between Doheny Road and North Alameda Street. Following the “paste-up” layout method and aesthetic that Ruscha followed in Every Building, the site digitally stitches these photos into continuous strips that retain their distinctive identity as individual images. The ten miles they depict represent just a portion of the 22 miles of Sunset Boulevard that Ruscha photographed and only a sample of Los Angeles's neighborhoods, from West Hollywood to Chinatown. Likewise, despite their unusual duration, they index only a brief timespan of land that has been continuously inhabited for generations, including by the Tongva, Kizh, and Chumash peoples. Still, even through a geographically and temporally limited lens, this dense, largely commercial extent tells vivid stories of how a diverse range of Angelenos have continuously shaped and reshaped their city.</p>

      <p>To reveal such tales, the site locates Ruscha's Sunset photographs in space and time and joins them with an array of historical data sources—city directories, the U.S. Census, and local newspapers, among others—to provide greater context for the changes seen decade-by-decade. “All I was after was that store-front plane,” Ruscha once said of his Sunset photographs. Yet looking not just at the façade, but also behind it, proves a revelatory experience.</p>
      ...
      <p>Sunset Over Sunset comprises four main components. The <Styled.Link to='/'>Panorama</Styled.Link> view facilitates easy exploration of Ruscha's photographs over these ten miles, navigable by clicking on points along the map, via the “head west” or “head east” buttons (or the left and right keyboard arrow keys), or by entering addresses and selecting years in the “Search & Filter” menu. Clicking on an individual photo opens a detailed view of a single image in a pop-up viewer, including the ability to zoom in closely and navigate to the next or previous photo. Selecting an address on the numerical band spanning the Panorama page, or suggested as a “nearby address” in the pop-up photo viewer, brings up a deeper profile of historical data associated with that property. Available resources vary by location but may include Ruscha's photographs, historical occupants, census tract-level demographic data, journalistic coverage, and links to external property databases. Finally, <Styled.Link to='/stories'>Stories</Styled.Link> knit together photographs and properties to illuminate histories that have unfolded there, offering a platform to ask, “What story of Sunset do we tell if we tell it through ____?” <Styled.Link to='/stories/gasstations'>Gas Stations</Styled.Link>, banks, restaurants, palm trees, and signs, for example, all reveal specific stories of this street, as well as larger urban histories in decades of extensive global transformation. We invite you to explore these histories and use <cite>Sunset Over Sunset</cite> to write your own.</p>
        ...
        <p>Francesca Russello Ammon, Brian D. Goldstein, and Garrett Dash Nelson, "Sunset over Sunset", accessed {dateStr}, https://sunsetoversunset.org.</p>
